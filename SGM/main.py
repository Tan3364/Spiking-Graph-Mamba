...
#        if cfg.pretrained.dir and os.path.exists(cfg.pretrained.dir):
#            model = init_model_from_pretrained(
#                model, cfg.pretrained.dir, cfg.pretrained.freeze_main,
#                cfg.pretrained.reset_prediction_head
#            )
#        else:
#            logging.error(f"预训练模型路径不存在或未配置: {cfg.pretrained.dir}")
#            exit()
        ...
        for name, p in model.named_parameters():
            logging.info(f"Parameter name: {name}, shape: {p.shape}, requires_grad: {p.requires_grad}")

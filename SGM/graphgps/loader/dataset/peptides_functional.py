...
class PeptidesFunctionalDataset(InMemoryDataset):
    def __init__(self, root='datasets', smiles2graph=smiles2graph,
        ...
        try:
            ...
            print(f"安全加载失败，使用非安全模式（仅限可信数据）: {e}")
    ...
    def download(self):
        if decide_download(self.url):
            ...
            path = "../datasets/peptides-functional/raw/peptide_multi_class_dataset.csv.gz"
            ...
            path_split1 = "../datasets/peptides-functional/raw/splits_random_stratified_peptide.pickle"

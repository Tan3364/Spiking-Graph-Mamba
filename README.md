...
- SGM: a Spiking Graph-Mamba framework for energy-efficient long-range graph learning.
- SSDN: a Spike-Event Surrogate Dynamics Network that converts continuous representations into spike events.
